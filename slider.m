function slider()
    ...
    sliderLaplacianSigma = uicontrol('Style', 'slider', 'Min', 1, 'Max', 100, 'Value', 20, ...
        'Position', [10, 650, 120, 20], 'Callback', @updateImages);
    uicontrol('Style', 'text', 'Position', [10, 670, 120, 20], 'String', 'Laplacian Sigma');

    sliderGaussianSigma = uicontrol('Style', 'slider', 'Min', 1, 'Max', 100, 'Value', 20, ...
        'Position', [10, 600, 120, 20], 'Callback', @updateImages);
    uicontrol('Style', 'text', 'Position', [10, 620, 120, 20], 'String', 'Gaussian Sigma');

    sliderKernelSizeC = uicontrol('Style', 'slider', 'Min', 3, 'Max', 50, 'Value', 20, ...
        'Position', [10, 550, 120, 20], 'Callback', @updateImages);
    uicontrol('Style', 'text', 'Position', [10, 570, 120, 20], 'String', 'Kernel Size (C)');

    sliderKernelSizeL = uicontrol('Style', 'slider', 'Min', 3, 'Max', 50, 'Value', 20, ...
        'Position', [10, 500, 120, 20], 'Callback', @updateImages);
    uicontrol('Style', 'text', 'Position', [10, 520, 120, 20], 'String', 'Kernel Size (L)');

    sliderKernelSizeG = uicontrol('Style', 'slider', 'Min', 3, 'Max', 50, 'Value', 20, ...
        'Position', [10, 450, 120, 20], 'Callback', @updateImages);
    uicontrol('Style', 'text', 'Position', [10, 470, 120, 20], 'String', 'Kernel Size (G)');
    ...
    function updateImages(~, ~)
        ...
        sigmaL = get(sliderLaplacianSigma, 'Value');
        ...
        title(ax3, sprintf('Laplacian Kernel: Sigma = %.2f, Size = %d', sigmaL, kernelSizeL));
