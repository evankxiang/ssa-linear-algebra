...
sigmaL = 20;
sigmaG = 20;
cauchyKernel = createCauchyKernel(kernelSize, gamma);
laplacianKernel = createLaplacianKernel(kernelSize, sigmaL);
gaussianKernel = createGaussianKernel(kernelSize, sigmaG);
